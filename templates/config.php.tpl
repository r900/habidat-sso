...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => '{{ $ds.baseurlpath }}',
    'certdir' => '{{ $ds.certdir }}',
    'loggingdir' => '{{ $ds.loggingdir }}',
    'datadir' => '{{ $ds.datadir }}',
     ...
     */
    'showerrors' => {{ $ds.showerrors }},
    'errorreporting' => {{ $ds.errorreporting }},
     ...
     */
    'debug.validatexml' => {{ $ds.debug_validatexml }},
     ...
     */
    'auth.adminpassword' => '{{ $ds.auth_adminpassword }}',
    'admin.protectindexpage' => {{ $ds.admin_protectindexpage }},
    'admin.protectmetadata' => {{ $ds.admin_protectmetadata }},
     ...
     */
    'technicalcontact_name' => '{{ $ds.technicalcontact_name }}',
    'technicalcontact_email' => '{{ $ds.technicalcontact_email }}',
     ...
     *
     */
    'logging.level' => SimpleSAML_Logger::{{ $ds.loggin_level }},
    'logging.handler' => '{{ $ds.logging_handler }}',
     ...
     */
    'enable.saml20-idp' => {{ $ds.enable_saml20_idp }},
    'enable.shib13-idp' => {{ $ds.enable_shib13_idp }},
    'enable.adfs-idp' => {{ $ds.enable_adfs_idp }},
    'enable.wsfed-sp' => {{ $ds.enable_wsfed_sp }},
    'enable.authmemcookie' => {{ $ds.enable_authmemcookie }},
     ...
     */
    'session.duration' => {{ $ds.session_durration }},
     ...
     */
    'session.datastore.timeout' => {{ $ds.session_datastore_timeout }},

    /*
     * Sets the duration, in seconds, auth state should be stored.
     */
    'session.state.timeout' => {{ $ds.session_state_timeout }},

    /*
     * Option to override the default settings for the session cookie name
     */
    'session.cookie.name' => '{{ $ds.cookie_name }}',
     ...
     */
    'session.cookie.lifetime' => {{ $ds.session_cookie_lifetime }},
     ...
     */
    'session.cookie.domain' => {{ if $ds.session_cookie_domain }}'{{ $ds.session_cookie_domain }}'{{ else }}null{{ end }},
     ...
     */
    'enable.http_post' => {{ $ds.enable_http_post }},

    /*
     * Options to override the default settings for php sessions.
     */
    'session.phpsession.cookiename' => {{ if $ds.session_phpsession_cookiename }}'{{ $ds.session_phpsession_cookiename }}'{{ else }}null{{ end }},
    'session.phpsession.savepath' => {{ if $ds.session_phpsession_savepath }}'{{ $ds.session_phpsession_savepath }}'{{ else }}null{{ end }},
    'session.phpsession.httponly' => {{ $ds.session_phpsession_httponly }},

    /*
     * Option to override the default settings for the auth token cookie
     */
    'session.authtoken.cookiename' => '{{ $ds.session_authtoken_cookiename }}',
     ...
     */
    'session.rememberme.enable' => {{ $ds.session_rememberme_enable }},
    'session.rememberme.checked' => {{ $ds.session_rememberme_checked }},
    'session.rememberme.lifetime' => {{ $ds.session_rememberme_lifetime }},
    ...
    'language.default' => '{{ $ds.language_default }}',

    /*
     * Options to override the default settings for the language parameter
     */
    'language.parameter.name' => '{{ $ds.language_parameter_name }}',
    'language.parameter.setcookie' => {{ $ds.language_parameter_setcookie }},

    /*
     * Options to override the default settings for the language cookie
     */
    'language.cookie.name' => '{{ $ds.language_cookie_name }}',
    'language.cookie.domain' => {{ if $ds.language_cookie_domain }}'{{ $ds.language_cookie_domain }}'{{ else }}null{{ end }},
    'language.cookie.path' => '{{ $ds.language_cookie_path }}',
    'language.cookie.lifetime' => {{ $ds.language_cookie_lifetime }},
